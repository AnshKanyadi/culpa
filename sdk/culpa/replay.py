"""
Deterministic replay engine for Culpa.
...
class StubAnthropicClient:
    ...
    def __init__(self, replayer: CulpaReplayer) -> None:
...
class CulpaReplayer:
    """
    Replays a recorded Culpa session deterministically.
    ...
    @classmethod
    def from_session(cls, session: Session) -> CulpaReplayer:
