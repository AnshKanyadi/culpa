"""
Pydantic models for all Culpa events and session data.
...
class EventType(str, Enum):
    """Types of events that can be recorded in a Culpa session."""
...
class BaseEvent(BaseModel):
    """Base class for all Culpa events."""
...
class Session(BaseModel):
    """
    A complete recorded Culpa session.
