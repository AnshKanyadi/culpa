"""
File system watcher for Prismo.
...
class FileSystemWatcher:
    """
    Monitors a directory for file system changes during a Prismo session.
    ...
    def __init__(self, watch_directory: str, recorder: Any) -> None:
        ...
        Args:
            ...
            recorder: PrismoRecorder instance to record file changes into.
        """
    ...
    def _start_watchdog(self) -> None:
        ...
        class PrismoEventHandler(FileSystemEventHandler):
        ...
        self._observer.schedule(PrismoEventHandler(), self._directory, recursive=True)
